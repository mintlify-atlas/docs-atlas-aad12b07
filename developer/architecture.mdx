...
description: "Overview of SparkyFitness's full-stack architecture: React 18 frontend, Node.js/Express backend, PostgreSQL with Row-Level Security, and Docker-based deployment."
---
...
```
SparkyFitness/
├── SparkyFitnessFrontend/    # React 18 + Vite web application
