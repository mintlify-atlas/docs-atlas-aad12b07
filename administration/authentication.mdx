---
title: "Configure Authentication in SparkyFitness"
sidebarTitle: "Authentication"
description: "Set up email/password login, OpenID Connect (OIDC) SSO, TOTP two-factor authentication, Passkeys, and multi-factor authentication in SparkyFitness."
---
