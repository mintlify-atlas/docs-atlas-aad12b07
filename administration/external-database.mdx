...
description: "Configure SparkyFitness to connect to an existing external PostgreSQL 15+ server instead of the bundled Docker database container for production use."
---
