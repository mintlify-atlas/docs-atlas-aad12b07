...
description: "Use SparkyAI to log food, workouts, water, and body stats via natural language chat. Supports OpenAI, Anthropic, Google, and any OpenAI-compatible endpoint."
---
